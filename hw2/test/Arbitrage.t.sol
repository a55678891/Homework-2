...
contract Arbitrage is Test {
    ...
    function testExploit() public {
        ...
        router.swapExactTokensForTokens(tokenABalance, 0, pathAE, arbitrager, block.timestamp + 120);
        ...
        router.swapExactTokensForTokens(tokenEBalance, 0, pathED, arbitrager, block.timestamp + 120);
